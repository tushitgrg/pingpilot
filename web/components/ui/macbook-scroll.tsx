  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[32rem] bg-[#030712] rounded-2xl p-2 relative"
      >
        <div
          style={{
            boxShadow: "0px 2px 0px 2px var(--neutral-900) inset",
          }}
          className="absolute inset-0 bg-[#030712] rounded-lg flex items-center justify-center"
        >
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-[#030712] rounded-2xl p-2"
      >
        <div className="absolute inset-0 bg-[#030712] rounded-lg" />
        <Image
